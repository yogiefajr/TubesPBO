 ...
 * @author tinodau
 */
public class MhsHome extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MhsHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
